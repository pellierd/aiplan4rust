...
use crate::common::compiler::{normalize_and_check_ast, parse_and_check_ast};
use crate::common::io::{
...
///
/// ```
/// test_hddl_normalizer("tests/fixtures/hddl/ipc20/partial-order/total-order");
/// ```
///
/// # Notes
///
...
///
/// ```
/// let success = test_parse_and_normalize_all_files(Path::new("tests/fixtures/hddl/ipc20/partial-order/total-order"), &Language::HDDL);
/// assert!(success);
/// ```
