...
///
/// This implementation enables seamless use of a `NodeRef` wherever a `NodeId` is expected,
/// improving API ergonomics by avoiding the need for manual `.id()` calls.
///
/// # Example
///
/// ```rust
...
///
/// let node_ref: NodeRef = /* obtain a NodeRef somehow */;
