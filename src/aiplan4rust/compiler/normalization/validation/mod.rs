//! Provides utilities and checks for validating the correctness and logic of AST nodes.
//!
...
//! and use those in [`validator`] to assert logic properties of AST nodes.
//!
//! # Examples
//!
//! ```rust
...
use crate::aiplan4rust::compiler::syntax::validation::ValidationError;
