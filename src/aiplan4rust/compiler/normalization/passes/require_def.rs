...
//!
//! The logic pass is standalone and can be run independently at any point.
...
use crate::aiplan4rust::compiler::syntax::ast::Ast;
...
///
/// The logic process does not traverse the entire AST. Instead, it directly locates the
...
/// logic logic, and can safely be run independently at any point, provided the AST is
/// valid.
///
/// # Arguments
///
...
/// * No other logic logic are required before or after this one.
