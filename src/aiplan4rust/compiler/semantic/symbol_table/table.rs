...
use crate::aiplan4rust::compiler::semantic::signature_checker::MatchResult;
use crate::aiplan4rust::compiler::semantic::symbol::Declaration;
use crate::aiplan4rust::compiler::semantic::symbol::Filterable;
use crate::aiplan4rust::compiler::semantic::symbol::Scope;
use crate::aiplan4rust::compiler::semantic::symbol::SymbolEntry;
...
use crate::aiplan4rust::compiler::semantic::type_checker::TypeHierarchy;
...
pub struct Table {
    ...
    pub(in crate::aiplan4rust) symbols: Vec<SymbolEntry>,

    /// Indicates the origin context of the symbol table (e.g., Domain, Problem, Merged).
    pub(in crate::aiplan4rust) origin: SymbolTableOrigin,

    /// Root node ID used to construct the root scope.
    pub(in crate::aiplan4rust) root_id: NodeId,
    ...
    pub(in crate::aiplan4rust) declarations_index: Vec<Option<SymbolRef>>,
    pub(in crate::aiplan4rust) usages_index: Vec<Option<SymbolRef>>,
}
