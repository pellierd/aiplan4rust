...
pub type NodeId = crate::aiplan4rust::compiler::syntax::ast::arena::NodeId;
pub type NodeRef<'a, T> = crate::aiplan4rust::compiler::syntax::ast::arena::NodeRef<'a, T>;
pub type NodeRefMut<'a, T> =
    crate::aiplan4rust::compiler::syntax::ast::arena::node_ref::NodeRefMut<'a, T>;
