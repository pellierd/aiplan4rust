...
use crate::aiplan4rust::compiler::semantic::checks::SemanticCheckError;
use crate::aiplan4rust::compiler::semantic::passes::SemanticPassError;
use crate::aiplan4rust::compiler::semantic::symbol::Symbol;
...
pub enum LinkingError {
    ...
    #[error(transparent)]
    SemanticPass(#[from] FinalizationError),
