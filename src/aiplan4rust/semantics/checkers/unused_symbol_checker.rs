...
pub struct UnusedSymbolChecker;

impl UnusedSymbolChecker {
    ...
    pub fn check(
        ...
        for symbol in symbol_table.values() {
            for declaration in symbol.declarations() {
                if Self::skip_unused_symbol_declaration(symbol, declaration, ast_table)?
                ...
                Self::check_pddl_builtin_symbol_declaration(symbol, declaration, tree, errors)?;
