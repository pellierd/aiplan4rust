...
pub fn check_atomic_formula_skeleton(ast: &Ast, node: &AstNode) -> Result<(), WellFormedError> {
    ...
    match children_len {
        1 => common::checks::check_child_kind(ast, node, 0, &[AstKind::PredicateSymbol]),
        2 => {
...
pub fn check_atomic_function_skeleton(ast: &Ast, node: &AstNode) -> Result<(), WellFormedError> {
    ...
    match children_len {
        1 => common::checks::check_child_kind(ast, node, 0, &[AstKind::FunctionSymbol]),
        2 => {
...
pub fn check_action_def_body(ast: &Ast, node: &AstNode) -> Result<(), WellFormedError> {
    ...
    match children_len {
        0 => Ok(()),
        1 => common::checks::check_child_kind(
            ast,
            node,
            0,
...
pub fn check_initial_task_network(ast: &Ast, node: &AstNode) -> Result<(), WellFormedError> {
    ...
    match node.arity() {
        1 => common::checks::check_child_kind(ast, node, 0, &[AstKind::TaskNetworkDef]),
        2 => {
