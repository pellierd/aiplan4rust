...
impl<'a> DiagnosticManager<'a> {
    ...
    pub fn add_diagnostic(&mut self, diagnostic: Diagnostic<'a>) {
        self.diagnostics.push(diagnostic);
    }
    pub fn add_diagnostics(&mut self, diagnostics: Vec<Diagnostic<'a>>) {
    ...
    pub fn add_errors_from(&mut self, other: &DiagnosticManager<'a>) {
