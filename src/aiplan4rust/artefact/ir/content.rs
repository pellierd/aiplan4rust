...
//! design ensures typing-safe access to the underlying data while preserving format
...
impl IRContent {
    ...
    ///
    /// # Returns
    /// - `IRKind`: The semantic typing of this IR content (`ParsedDomain`, `ParsedProblem`, or `LiftedProblem`).
