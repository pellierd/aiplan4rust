...
use crate::aiplan4rust::tree::node::TreeNode;
...
/// }
/// ```
pub struct PostorderIter<'a, T: TreeNode> {
    arena: &'a TreeArena<T>,
    stack: Vec<(NodeId, usize)>,
}

impl<'a, T: TreeNode> PostorderIter<'a, T> {
...
impl<'a, T: TreeNode> Iterator for PostorderIter<'a, T> {
    type Item = &'a T;
