...
use crate::aiplan4rust::lir::normalization::logic::expr;
...
pub fn normalize(
    ...
    if is_durative {
        if let Some(duration) = action.duration() {
            ...
            println!("Normalizing Action Duration...");
    ...
    println!("Normalizing Action Precondition   ...");
    ...
    println!("Normalizing Action Effect   ...");
