...
use crate::aiplan4rust::lir::old::passes::typing::registry::TypeRegistry;
use crate::aiplan4rust::lir::old::passes::typing::{
...
mod tests {
    ...
    use crate::aiplan4rust::lir::old::expr::ExprBuilder;
    use crate::aiplan4rust::lir::old::problem::LiftedProblem;
