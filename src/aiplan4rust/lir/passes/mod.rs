...
//! It organizes various transformation "passes" that refine the raw encoded problem into a 
...
//! ## The Facade Pattern
//!
//! To maintain a clean API, the internal complexity of these passes is hidden. The 
...
// This allows callers to use `passes::normalize(&mut problem)` directly.
