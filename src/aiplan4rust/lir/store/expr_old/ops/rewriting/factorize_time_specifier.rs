use crate::aiplan4rust::lir::store::expr_old::ops::rewriting::push_time_specifier::push_time_specifier;
use crate::aiplan4rust::lir::store::expr_old::ops::ExprOpError;
use crate::aiplan4rust::lir::store::expr_old::{Expr, ExprContent, ExprKind, ExprNode};
...
pub fn factorize_time_specifier(root_id: NodeId, expr: &mut Expr) -> Result<bool, ExprOpError> {
...
mod tests {
    ...
    fn test_normalize_temporal_complex() -> Result<(), ExprOpError> {
        ...
        assert_eq!(
            expr.try_node_kind(expr.try_node(and_a_id)?.children()[0])?,
        ...
        assert_eq!(
            expr.try_node_kind(expr.try_node(and_b_id)?.children()[0])?,
            ExprKind::AtomicFormula
        );
    ...
    fn test_normalize_temporal_nested_overall_or() -> Result<(), ExprOpError> {
        ...
        assert_eq!(
            expr.try_node_kind(inner_start.children()[0])?,
            ExprKind::AtomicFormula
        ); // A
        ...
        assert_eq!(
            expr.try_node_kind(end_or.children()[0])?,
            ExprKind::AtomicFormula
        ); // C
        ...
        assert_eq!(
            expr.try_node_kind(overall_or.children()[0])?,
            ExprKind::AtomicFormula
        ); // B
    ...
    fn test_normalize_temporal_deeply_nested() -> Result<(), ExprOpError> {
        ...
        assert_eq!(
            expr.try_node_kind(end_not.children()[0])?,
            ExprKind::AtomicFormula
        );
    ...
    fn test_normalize_temporal_complex_nested() -> Result<(), ExprOpError> {
        ...
        assert_eq!(
            expr.try_node_kind(and_a.children()[0])?,
            ExprKind::AtomicFormula
        );
        ...
        assert_eq!(
            expr.try_node_kind(expr.try_node(not_c_id)?.children()[0])?,
            ExprKind::AtomicFormula
        );
        ...
        assert_eq!(
            expr.try_node_kind(and_b.children()[0])?,
            ExprKind::AtomicFormula
        );
    ...
    fn test_normalize_temporal_atstart_forall() -> Result<(), ExprOpError> {
        ...
        assert_eq!(
            expr.try_node_kind(or_child.children()[0])?,
            ExprKind::AtomicFormula
        ); // A
        assert_eq!(
            expr.try_node_kind(or_child.children()[1])?,
            ExprKind::Forall
        ); // forall
        ...
        assert_eq!(inner_end.kind(), ExprKind::And);
        assert_eq!(
            expr.try_node_kind(inner_end.children()[0])?,
            ExprKind::AtomicFormula
        ); // C
