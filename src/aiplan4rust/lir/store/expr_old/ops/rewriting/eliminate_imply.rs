...
mod tests {
    ...
    fn test_nested_imply() -> Result<(), ExprOpError> {
        ...
        assert_eq!(
            expr.try_node_kind(inner_or.children()[1])?,
    ...
    fn test_imply_with_and_consequence() -> Result<(), ExprOpError> {
        ...
        assert_eq!(
            expr.try_node_kind(expr.try_node(not_id)?.children()[0])?,
            ExprKind::AtomicFormula
        );
        ...
        assert_eq!(
            expr.try_node_kind(and_node.children()[0])?,
            ExprKind::AtomicFormula
        );
        assert_eq!(
            expr.try_node_kind(and_node.children()[1])?,
            ExprKind::AtomicFormula
        );
