//! Typed List Encoding
//!
//! This module provides functions to parse and encoding_old lists of typed symbols.
...
/// the encoding_old of each element to the `typed_symbol` module. The resulting
...
/// * `Err(LirError)` - If any individual symbol fails to encoding_old or if the AST
...
/// * The `typed_symbol::encoding_old` process fails (e.g., due to an unknown typing).
