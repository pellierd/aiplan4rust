...
//!
//! This module handles the entry point of HTN problems by encoding_old the
...
use crate::aiplan4rust::lir::store::encoding_old::{task_network, typed_list};
...
pub fn encode(
    ...
    // Le task_network::encoding_old pourra maintenant utiliser evaluator.try_resolve_variable
