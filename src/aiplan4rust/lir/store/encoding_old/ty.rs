...
//!
//! The encoding_old process follows a strict two-pass architecture:
...
use crate::aiplan4rust::lir::store::encoding_old::EncodingRegistry;
...
/// * `evaluator` - The encoding_old evaluator containing the resolved symbol-to-typing mapping.
///
/// # Returns
///
