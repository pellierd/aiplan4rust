...
//!
//! This module handles the encoding_old of atomic formula structures (predicates).
...
use crate::aiplan4rust::lir::store::encoding_old::{ty, typed_list, EncodingRegistry};
use crate::aiplan4rust::lir::store::problem_old::atomic_skeleton::AtomicFunctionSkeleton;
...
/// # Errors
///
/// Returns an error if the underlying `named_typed_list::encoding_old` fails,
...
pub fn encode(
    ...
    debug_assert!(
        ...
        "The provided functor ID is invalid."
    );
