...
//!
//! This module provides the core ops for encoding_old global symbols into the LIR.
...
use crate::aiplan4rust::lir::store::encoding_old::{typed_symbol, EncodingRegistry};
...
///
/// This function coordinates the encoding_old process in two distinct phases to ensure
...
/// * `registry` - The mutable encoding_old registry used for symbol-to-ID binding and lookups.
...
/// Phase 1: Collects object identifiers, filters them, and prepares the encoding_old whitelist.
///
...
/// consistency between object registration and definition encoding_old.
///
/// # Returns
...
/// * `registry` - The encoding_old registry used for type and symbol resolution.
