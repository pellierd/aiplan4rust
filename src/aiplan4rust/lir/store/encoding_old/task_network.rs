...
//!
//! This module provides functionality to encoding_old Hierarchical Task Networks (HTN).
...
use crate::aiplan4rust::lir::store::encoding_old::{expr, EncodingRegistry};
use crate::aiplan4rust::lir::store::expr_old::{Expr, ExprContent, ExprKind};
use crate::aiplan4rust::lir::store::problem_old::task_network::TaskNetwork;
...
/// * `Err(LirError)` - If the AST contains unexpected nodes or if expression encoding_old fails.
///
/// # Errors
///
...
/// Main entry point for Task Network encoding_old.
...
pub fn encode(
    ...
    // PASS 2: Perform the actual expression encoding_old
