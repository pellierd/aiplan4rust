...
//!
//! This module provides utilities to encoding_old PDDL symbols (such as constants, objects,
...
use crate::aiplan4rust::lir::store::encoding_old::{ty, EncodingRegistry};
...
/// * `evaluator` - The encoding_old context used to resolve typing identifiers.
///
/// # Returns
///
...
/// * The second child (the typing definition), if present, fails the encoding_old process
...
pub fn encode_typed_type(
    ...
    let ty = if children.len() > 1 {
        ...
        // Delegate to the typing encoding_old module to resolve the TypeID(s)
