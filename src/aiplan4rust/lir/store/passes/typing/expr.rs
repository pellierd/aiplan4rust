...
use crate::aiplan4rust::lir::store::passes::typing::{typed_symbol, TypeRegistry};
...
///
/// # Parameters
/// * `expr_old` - A mutable reference to the [`Expr`] tree to be normalized.
...
///
/// # Parameters
/// * `expr_old` - A mutable reference to the [`Expr`] tree.
...
pub fn normalize_from_node(
    ...
    while let Some(current_id) = stack.pop() {
        ...
        // Block scope is used to drop the mutable borrow of 'expr_old' before
