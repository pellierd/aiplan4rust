...
use crate::aiplan4rust::lir::store::problem_old::{DomainDef, ProblemDef};
use crate::aiplan4rust::lir::store::renderers_old;
use crate::aiplan4rust::lir::{
    ActionDef, DerivedPredicateDef, InitialTaskNetwork, LirError, MethodDef,
};
...
impl Display for Problem {
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        renderers_old::default::render_problem(f, self)
    }
}
