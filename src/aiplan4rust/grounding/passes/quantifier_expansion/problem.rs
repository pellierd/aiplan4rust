...
use crate::aiplan4rust::grounding::passes::quantifier_expansion::{action, derived_predicate, expr, method};
...
pub fn expand_with(
    ...
    expr::expand_with(&mut problem.domain_constraints_mut(), value_registry, evaluator)?;
    expr::expand_with(&mut problem.problem_constraints_mut(), value_registry, evaluator)?;
